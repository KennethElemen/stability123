          ...
          <tr>
              ...
              <td>
                  <select name="staphylococcus_aureus" class="form-control" required>
                      <option value="<?php echo htmlspecialchars($product['salmonella']); ?>" >Select</option>
                      <option value="Positive">Positive</option>
                      <option value="Negative">Negative</option>
                  </select>
              </td>
            ...
            <tr>
              <td>Salmonella Species</td>
              <td><input type="text" name="salmonella" class="form-control"  value="<?php echo htmlspecialchars($product['salmonella']); ?>" required></td>
              <td colspan="8"></td>
            </tr>
            <tr>
              <td>Escherichia coli</td>
              <td><input type="text" name="escherichia_coli" class="form-control"  value="<?php echo htmlspecialchars($product['escherichia_coli']); ?>" required></td>
              <td colspan="8"></td>
            </tr>
            <tr>
              <td>Staphylococcus Aureus</td>
              <td><input type="text" name="staphylococcus_aureus" class="form-control"  value="<?php echo htmlspecialchars($product['staphylococcus_aureus']); ?>" required></td>
              <td colspan="8"></td>
            </tr>
            <tr>
